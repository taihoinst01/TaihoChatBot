...
using TaihoChatBotV3.DB;
using TaihoChatBotV3.Models;
using Newtonsoft.Json.Linq;

using System.Configuration;
using System.Web.Configuration;
using TaihoChatBotV3.Dialogs;
using System.IO;
using System.Text;
        ...
        public async Task<HttpResponseMessage> Post([FromBody]Activity activity)
        {
            ...
            else if (activity.Type == ActivityTypes.Message)
            {
                ...
                try
                {
                    ...
                    if (queryStr.Contains("current location") || orgMent.Equals("현재 위치 사용 승인") || orgMent.Contains("current location"))
                    {
                        DButil.HistoryLog("queryStr===" + queryStr);
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else if (MessagesController.cacheList.luisId.Equals("TaihoChatBotV3_luis_01") && MessagesController.cacheList.luisIntent.Contains("quot"))
                            {
                                apiFlag = "QUOT";
                            }
